...
@Relation(collectionRelation = "formas-pagamento") // Anotação para configurar o nome da lista que o hateoas vai representar na coleção de FromaPagamentoDTO para o formas-pagamento
@Data
@NoArgsConstructor
@AllArgsConstructor
