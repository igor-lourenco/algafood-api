...
public class PedidoLinks {
    ...
    public Link addCollectionLink(String rel){
        ...
        return WebMvcLinkBuilder       //  adiciona o link HATEOAS ao objeto.
            ...
            .withRel(rel); // Representa o URI para a coleção de recursos do mesmo tipo do recurso atual do pedido
    }
    ...
    public Link addPesquisaPedidoLink() {
        try {
...
//            );
    ...
    public Link addPesquisaPaginadaPedidoLink() {
        try {
            Class<?> controllerClass = PedidoController.class;
            Class<?> pedidoFilterClass = PedidoFilter.class;
    ...
    public Link addLimitaOsCamposPedidoLink() {
        Class<?> controllerClass = PedidoController.class;
