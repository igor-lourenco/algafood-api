...
import com.algaworks.algafood.api.assemblers.links.EstatisticaLinks;
...
public class VendaDiariaDTOAssembler {
    ...
    public VendaDiariaDTO estatisticas() {
        VendaDiariaDTO vendaDiariaDTO = new VendaDiariaDTO();

        vendaDiariaDTO.add(estatisticaLinks.addVendaDiariaLink("vendas-diarias"));

        return vendaDiariaDTO;
    }
}
