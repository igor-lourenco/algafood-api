...
public interface GrupoControllerOpenApi {
    ...
    @Operation(summary = "Exclui grupo pelo ID", responses = {
        @ApiResponse(responseCode = "204", description = "Grupo deletado com sucesso", content = @Content(schema = @Schema)),})
    void deleta(@Parameter(name = "grupoId", description = "ID do grupo", example = "1", required = true, schema = @Schema(type = "integer")) Long id);
