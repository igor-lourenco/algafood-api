...
insert into tb_restaurante (id, nome, taxa_frete, cozinha_id) values (4, 'The Test Kitchen', 15, 5);
insert into tb_restaurante (id, nome, taxa_frete, cozinha_id) values (5, 'La Maison Arabe', 15, 4);
insert into tb_restaurante (id, nome, taxa_frete, cozinha_id) values (6, 'Enqutatash ', 15, 3);
